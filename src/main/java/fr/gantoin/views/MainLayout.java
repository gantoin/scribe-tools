...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(DashboardView.class)) {
            nav.addItem(new SideNavItem("Dashboard", DashboardView.class, LineAwesomeIcon.FILTER_SOLID.create()));

        }
        if (accessChecker.hasAccess(EditView.class)) {
            nav.addItem(new SideNavItem("Edit", EditView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
